...
class VectorSearchService:
    ...
    async def index_idea(self, idea: Idea) -> bool:
        ...
        try:
            ...
            if idea.department_assignment:
                metadata["department_assignment"] = str(idea.department_assignment)
            if idea.institution_assignment:
                metadata["institution_assignment"] = str(idea.institution_assignment)
